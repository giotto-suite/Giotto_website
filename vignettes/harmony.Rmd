...
between the two datasets for similar tissue/cell types. Now the major separation
seen in the UMAP is based on Normal vs Cancer tissue instead of by sample,
a separation that is actually expected and biologically interesting.
...
Plotting AMACR (Alpha-Methylacyl-CoA Racemase), a gene that shows strong overexpression
in prostate cancer further confirms this region as being cancerous.
...
knitr::include_graphics("images/harmony/6_amacr.png")
```

These show that morphological and molecular information support the clustering
results and that the integration worked correctly, preserving the biological
