...
The osmFISH data to run this tutorial can be found [here](https://github.com/giotto-suite/spatial-datasets/tree/master/data/2018_osmFISH_SScortex). Alternatively you can use the **getSpatialDataset** to automatically download this dataset like we do in this example; to download the data used to create the Giotto Object below, please ensure that
