...
You should now have the count matrix for Giotto Object. Note the Spatial Barcodes are typically at 0.6 um resolution. One way to analyze is to use the getSimpleGrid.R or getSlidingGrid.R provided by Lee Lab to bin the counts and simply follow the Giotto analysis steps of [Visium](https://giotto-suite.github.io/Giotto_website/articles/visium_mouse_brain.html) and [Integration of Visium](https://giotto-suite.github.io/Giotto_website/articles/visium_prostate_integration.html)
...
# Create Giotto Subcellular Object
...
## Process Giotto Point file per tile
...
# Process Giotto and Quality Control
