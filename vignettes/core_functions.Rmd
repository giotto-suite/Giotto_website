...
Other examples, starting with different data types can be found in the [object creation](articles/object_creation.html) tutorial.
```{r, eval=FALSE}
...
For a more information, see the object [splitting and joining](articles/split_join.html) tutorial
