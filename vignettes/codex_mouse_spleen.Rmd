...
The CODEX data to run this tutorial can be found [here](https://github.com/giotto-suite/spatial-datasets/tree/master/data/2018_codex_spleen). Alternatively you can use **GiottoData::getSpatialDataset** to automatically download this dataset like we do in this example.
