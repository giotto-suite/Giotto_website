---
title: "Integrate MISTy Analysis"
output: 
  html_document:
...
pkgdown:
  as_is: true
vignette: >
  %\VignetteIndexEntry{Integrate MISTy Analysis}
...
# Introduction
This tutorial explains how to integrate MISTy with Giotto to analyze a human lung cancer dataset derived from Xenium, demonstrating how variations in cell-type composition and pathway activity shape spatial gene expression patterns.
...
```
# Data Setup
## Configure Paths and Download Data
...
knitr::include_graphics("images/integrate_misty_analysis/he.png")
```
...
*Image from Section 10.1.2 of the [2024 Giotto Workshop](https://drieslab.github.io/giotto_workshop_2024/xenium-1.html#aggregate-analyses-workflow).*
...
## Visualizing Top Ranked Marker Genes
...
``` 
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/20_ViolinPlot.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/21_Dotplot.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/10A_DimFeatPlot2D.png")
```
...
## Prepare Cell Type Composition Matrix
...
MISTy, [Tanevski et al. 2022](https://doi.org/10.1186/s13059-022-02663-5), 
is a computational framework designed to explore how different biological factors interact within spatially resolved transcriptomics data.
...
## Creating Juxtaview and Paraview Spatial Views
...
- **intra**  
   - Measures how well the intrinsic features of each cell (predictors) predict the corresponding target features of the same cell (self-prediction).

- **juxta.10**  
   - Measures how well pathway activity within 10 μm neighborhoods (predictors) predicts target features. 

- **para.15**  
   - Measures how well pathway activity within 15 μm neighborhoods (predictors) predicts target features.

- **juxtaview.composition.10**  
   - Measures how well cell composition within 10 μm neighborhoods (predictors) predicts target features.

- **paraview.composition.15**  
   - Measures how well cell composition within 15 μm neighborhoods (predictors) predicts target features. 
...
## Model Performance and Contributions
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/1_CompleteIntra.png")
```

```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/2_CompleteGain.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/3_SpatialGain.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/4_CompleteContributions.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/5_SpatialContributions.png")
```
...
After evaluating model performance, MISTy interaction heatmaps then reveal the specific spatial relationships that drive predictive performance. These visualizations shows which spatial features (predictors) most strongly influence target expression patterns.

### Intrinsic-Adjusted Spatial Heatmaps
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/6_CompletePathwayJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/7_CompleteCompositionJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/8_CompletePathwayPara.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/9_CompleteCompositionPara.png")
```




### Pure Spatial Relationship Heatmaps
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/10_SpatialPathwayJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/11_SpatialCompositionJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/12_SpatialPathwayPara.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/13_SpatialCompositionPara.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/14_TRAILPathway.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/15_BCellLocations.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/16_EGFRPathway.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/17_LUADCancerLocations.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/18_NFKBPathway.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/integrate_misty_analysis/19_NKTCellLocations.png")
```
