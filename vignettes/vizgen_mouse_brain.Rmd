...
This vignette covers Giotto object creation and simple exploratory analysis with the subcellular [MERFISH Mouse Brain Receptor Map dataset](https://info.vizgen.com/mouse-brain-data) provided by Vizgen with their MERSCOPE platform.
...
# Create Giotto object from aggregated data
...
# Working with subcellular information {#sec-subcellular}
