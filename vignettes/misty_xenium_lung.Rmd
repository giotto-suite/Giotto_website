---
title: "MISTy Analysis of Xenium Lung Cancer"
output: 
  html_document:
...
pkgdown:
  as_is: true
vignette: >
  %\VignetteIndexEntry{MISTy Analysis of Xenium Lung Cancer}
...
# Introduction
This tutorial demonstrates how MISTy with Giotto can be applied to a Xenium-derived human lung cancer dataset to reveal how variations in cell-type composition and pathway activity shape spatial gene expression patterns.
...
knitr::include_graphics("images/misty_xenium_lung/he.png")
```
...
``` 
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/20_ViolinPlot.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/21_Dotplot.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/10A_DimFeatPlot2D.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/1_CompleteIntra.png")
```

```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/2_CompleteGain.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/3_SpatialGain.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/4_CompleteContributions.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/5_SpatialContributions.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/6_CompletePathwayJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/7_CompleteCompositionJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/8_CompletePathwayPara.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/9_CompleteCompositionPara.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/10_SpatialPathwayJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/11_SpatialCompositionJuxta.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/12_SpatialPathwayPara.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/13_SpatialCompositionPara.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/14_TRAILPathway.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/15_BCellLocations.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/16_EGFRPathway.png")
```
...
```
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/17_LUADCancerLocations.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/18_NFKBPathway.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("images/misty_xenium_lung/19_NKTCellLocations.png")
```
