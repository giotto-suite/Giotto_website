# Resolve Bioscience Human lung Subcellular

## 1 Dataset explanation

This dataset was generated in-house at Resolve Biosciences using
customer-provided tissue sections. The experiment used a custom 34-gene
target panel to measure gene expression in situ for five samples across
three Molecular observation slides (Slide 873, Sample C1; Slide 874,
Sample D2; Slide 879, Samples B1, C2, D2). The dataset contains DAPI
image, expression matrix, gene list, and cell segmentation files for
download. Data made available with kind permission from a Resolve
Biosciences customer.

You can download the files
[here](https://resolvebiosciences.com/datasets/human-lung-dataset/). To
run this example, we will use the Molecular observation slide 873.
...
## 4 Create Subcellular Giotto Object

``` r

testobj <- createGiottoObjectSubcellular(
...
## 6 Add Image Information

``` r

# create Giotto images
DAPI_image <- createGiottoImage(
    gobject = testobj,
    name = "DAPI",
    do_manual_adj = TRUE,
...
## 8 Calculate Cell Shape Overlap
...
## 15 Find Interaction Changed Features
