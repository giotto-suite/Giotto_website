...
[CosMx Spatial Molecular Imager (SMI)](https://nanostring.com/) was used
to characterize human pancreas FFPE tissue with a 18,946 plex
pre-commercial version of the CosMx Human Whole Transcriptome panel.
This dataset was generated using a prototype version of the panel and
related software.

More information about this dataset can be found
[here.](https://nanostring.com/products/cosmx-spatial-molecular-imager/ffpe-dataset/cosmx-smi-human-pancreas-ffpe-dataset/)

## 2 Download the dataset

Download the CosMx human pancreas FFPE dataset from
[here](https://nanostring.com/products/cosmx-spatial-molecular-imager/ffpe-dataset/cosmx-smi-human-pancreas-ffpe-dataset/).
Go to DOWNLOAD DATA \> Basic Data Files. Once you have downloaded the
.zip file, decompress the the file in your working directory.
...
## 4 Create the Giotto object using the provided aggregated expression matrix

You can create the object using the expression file that contains the
...
Alternatively, you can create the object using the transcripts file and
then aggregate the features per polygon/cell in a step below.
...
![](images/cosmx_pancreas/0-spatInSituPlotPoints.png)
...
![](images/cosmx_pancreas/1-spatInSituPlotDensity.png)

## 7 Aggregate subcellular features

For more information on feature aggregation, click
[here](https://giottosuite.com/articles/feature_aggregation.html)
...
![](images/cosmx_pancreas/2-spatPlot2D.png)
...
![](images/cosmx_pancreas/3-filterDistributions.png)
...
![](images/cosmx_pancreas/4-filterDistributions.png)
...
![](images/cosmx_pancreas/5-spatPlot2D.png)
...
![](images/cosmx_pancreas/6-spatInSituPlotPoints.png)
...
the “pearson” expression matrix. These results will be returned in the
...
![](images/cosmx_pancreas/7-HVFplot.png)
...
![](images/cosmx_pancreas/8-screePlot.png)
...
![](images/cosmx_pancreas/9-PCA.png)
...
![](images/cosmx_pancreas/10-UMAP.png)
...
![](images/cosmx_pancreas/11-tSNE.png)
...
![](images/cosmx_pancreas/12-dimFeatPlot2D.png)
...
![](images/cosmx_pancreas/13-dimFeatPlot2D.png)
...
![](images/cosmx_pancreas/14-UMAP.png)
...
![](images/cosmx_pancreas/15-tSNE.png)
...
![](images/cosmx_pancreas/16-spatDimPlot2D.png)
...
![](images/cosmx_pancreas/17-spatInSituPlotPoints.png)
...
![](images/cosmx_pancreas/18-spatInSituPlotPoints.png)
...
![](images/cosmx_pancreas/19-spatInSituPlotPoints.png)
...
![](images/cosmx_pancreas/20-spatInSituPlotPoints.png)
