...
the*
[Configuration](https://giottosuite.com/dev/articles/configuration_04122023.md)
*and* [Giotto
Object](https://giottosuite.com/dev/articles/getting_started_gobject.md)
*vignettes before walking through this tutorial.*
...
Object](https://giottosuite.com/dev/articles/getting_started_gobject.md)
for further intuition on working with a **giottoObject** that has been
...
documentation](http://giottosuite.com/reference/createGiottoInstructions.md)
and [Giotto
Object](https://giottosuite.com/dev/articles/getting_started_gobject.md)
for default arguments and more details.
