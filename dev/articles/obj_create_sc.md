# Giotto Object Creation - Single Cell Data
...
The example dataset used here is from 10X
[link](https://www.10xgenomics.com/datasets/Human_PBMCs_Next_GEM_Flex_GEM-X_Flex_Comparison)
...
Read the expression matrix, which is provided from 10X as an h5 format.
[`get10Xmatrix_h5()`](https://giottosuite.com/dev/reference/get10Xmatrix_h5.md)
is a convenience function from `Giotto` that will import this format as
a *Matrix* `dgCMatrix` sparse matrix.
...
Single cell datasets should be loaded in through
[`createGiottoObject()`](https://giotto-suite.github.io/GiottoClass/reference/create_giotto.html).
During the load, a set of dummy spatial locations that can be safely
ignored will also be generated.
