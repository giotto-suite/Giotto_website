...
[here](https://github.com/giotto-suite/spatial-datasets/tree/master/data/2018_codex_spleen).
Alternatively you can use **GiottoData::getSpatialDataset** to
automatically download this dataset like we do in this example.

[Goltsev et
al.](https://www.cell.com/cell/pdf/S0092-8674(18)30904-8.pdf) created a
multiplexed datasets of normal and lupus (MRL/lpr) murine spleens using
CODEX technique. The dataset consists of 30 protein markers from 734,101
