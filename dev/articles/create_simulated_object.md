# Create a simulated Giotto object
...
### 4.1 Select the reference dataset to use

The simulator requires to learn the expression and/or spatial patterns
from a previous dataset. Select the dataset to use as reference. If you
haven’t downloaded the dataset, files you can download them in this
first step.

![](images/create_simulated_object/01_select_dataset.png)

### 4.2 Create the parameter file

Navigate through the questions to select the properties of the simulated
dataset.

![](images/create_simulated_object/02_create_paramfile.png)

### 4.3 Run the simulation

Choose what output you desire to obtain. By default, the simulator will
create a directory with the expression and spatial information.
Optionally, you can also create a local Giotto object. To follow this
tutorial select the option to create a Giotto object.

![](images/create_simulated_object/03_run_simulation.png)

## 5 Import the simulated data to Giotto

### 5.1 Read the expression matrix
...
### 5.2 Read the metadata and spatial locations
...
### 5.3 Create the Giotto instructions
...
![](images/create_simulated_object/0-spatPlot2D.png)
...
![](images/create_simulated_object/1-spatPlot2D.png)
...
![](images/create_simulated_object/2-spatPlot2D.png)
