# Giotto Object Creation - Piecewise
...
`giotto` analysis object. This method requires first loading the data in
as Giotto-compatible subobjects, after which they can be directly
appended to an empty `giotto` object.

For a more complete introduction to the data and Giotto subobjects used
here, see the point data Giotto object creation
[tutorial](https://giottosuite.com/dev/articles/obj_create_pnts.md)

## 1 Abbreviated data loading steps
...
## 2 Create a `giotto` object through appending subobjects
...
objects are created from scratch using
[`giotto()`](https://giotto-suite.github.io/GiottoClass/reference/giotto-class.html)
and when they are created through more guided approaches such as
[`createGiottoObject()`](https://giotto-suite.github.io/GiottoClass/reference/create_giotto.html)
and technology-specific convenience functions. This method of object
creation and modification can be helpful for editing the object, adding
additional modalities, or setting up objects for custom workflows.
