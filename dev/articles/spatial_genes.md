# Detection of spatial genes

Finding genes or features that follow spatial patterns in their
expression can help to better understand the spatial microenvironment of
the sample.
...
![](images/spatial_genes/1-spatPlot2D.png)

## 3 Rank binarization

Rank the genes on the spatial dataset depending on whether they exhibit
a spatial pattern location or not.
...
![](images/spatial_genes/2-spatFeatPlot2D.png)
