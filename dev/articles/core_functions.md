...
## 2 Spatial Aggregation (subcellular data only)

For use with raw subcellular data that has spatial boundaries/polygon
annotations and spatial features. Find overlapped feature information
...
## 4 Spatial Centroid Calculation (polygon annotations only)
...
For more detail, see the [standard
...
For a more information, see the object [splitting and
joining](https://giottosuite.com/dev/articles/split_join.md) tutorial
