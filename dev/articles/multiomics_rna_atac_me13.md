# Multi-omics spatial RNA-ATAC seq Mouse Embryo

## 1 Dataset explanation

The Mouse embryo ME13 spatial RNA-ATAC seq was originally published by
[Zhang et al. 2023](https://www.nature.com/articles/s41586-023-05795-1)
and downloaded from
<https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE205055>.

For running this tutorial, we will use the dataset ME13 (50 μm).
Download the following files and unzip the spatial folder:
...
## 5 Read ATAC information

We will use the [ArchR](https://www.archrproject.com) package to map the
atac fragments to the genome and create the Tile Matrix.
...
### 5.2 Create ArchR project from Arrow files
...
### 5.3 Get tile matrix from Arrow file
...
After keeping only the cells in common, you should get an atac matrix
with 526765 rows and 2172 cells

## 7 Create the Giotto object
...
![](images/multiomics_rna_atac_me13/0-screePlot.png)
...
### 10.2 Create shared nearest network (sNN) and perform Leiden clustering
...
### 10.3 Visualize UMAP cluster results
...
![](images/multiomics_rna_atac_me13/1-UMAP.png)
...
![](images/multiomics_rna_atac_me13/3-UMAP.png)

### 10.4 Visualize spatial results
...
![](images/multiomics_rna_atac_me13/2-spatPlot2D.png)
...
![](images/multiomics_rna_atac_me13/4-spatPlot2D.png)

## 11 Multi-omics integration

### 11.1 Create k nearest network
...
### 11.3 Create the integrated UMAP
...
### 11.4 Calculate integrated clusters
...
![](images/multiomics_rna_atac_me13/5-UMAP.png)

### 11.6 Plot spatial plot with integrated clusters
...
![](images/multiomics_rna_atac_me13/6-spatPlot2D.png)
