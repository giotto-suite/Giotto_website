...
tutorial will be revisited and utilized to create heatmaps, violin
plots, and visualizations that are unique to Giotto: spatial maps and
networks.

This tutorial uses a merFISH dataset of mouse hypothalamic preoptic
regions from [Moffitt et al.](https://doi.org/10.1126/science.aau5324).
A complete walkthrough of that dataset can be found
[here](https://giottosuite.com/dev/articles/merFISH_hypoth_220915.md).
...
![](images/visualizations/0-spatPlot2D.png)
...
![](images/visualizations/2-UMAP_2D.png)
...
![](images/visualizations/4-spatPlot2D.png)
...
![](images/visualizations/5-spatPlot2D.png)
...
![](images/visualizations/6-showClusterHeatmap.png)
...
![](images/visualizations/7-showClusterDendrogram.png)

## 7 Visualize Cell markers_gini

Marker features may be identified by calling
**findmarkers_gini_one_vs_all**. This function detects differentially
expressed features by comparing a single cluster to all others.
Currently, three methods are supported: “*scran*”, “*gini*”, and
“*mast*”. Here, the “*gini*” method is employed; details on the gini
method may be found
[here](https://giottosuite.com/dev/docs/reference/findGinimarkers_gini.md).
...
![](images/visualizations/8-violinPlot.png)
...
![](images/visualizations/9-plotMetaDataHeatmap.png)
...
![](images/visualizations/10-spatPlot2D.png)
...
![](images/visualizations/12-spatPlot2D.png)
...
[createSpatialNetwork](https://giottosuite.com/dev/docs/reference/createSpatialNetwork.md)
...
![](images/visualizations/delaunay_network.png)
...
![](images/visualizations/Delaunay_network_spatPlot.png)
...
![](images/visualizations/spatial_network_spatPlot.png)
...
![](images/visualizations/large_network_spatPlot.png)
...
![](images/visualizations/distance_network_spatPlot.png)
