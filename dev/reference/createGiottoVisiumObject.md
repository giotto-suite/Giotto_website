...
Create Giotto object directly from a 10X visium folder. Also accepts
visium H5 outputs.
...
- h5_image_png_path:
  ...
  path to tissue .png file (optional). Image autoscaling looks for
  matches in the filename for either "hires" or "lowres"
...
- the file scalefactors_json.json will be detected automatically and
