...
[`runPCA`](https://giottosuite.com/dev/reference/runPCA.md), except that
it performs PCA on a subset of the cells or features, and predict on the
others. This can significantly increase speed without sacrificing
accuracy too much.
