...
- nrand:
  ...
  An integer specifying the number of random resamplings of the mark
  distribution as to create the null-distribution.
...
[doi:10.1038/nmeth.4634](https://doi.org/10.1038/nmeth.4634)
