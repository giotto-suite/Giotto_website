...
NECESSARY PREREQUISITES 1. download and install the COMMAND line (all
platforms) gsea-XXX.jar https://www.gsea-msigdb.org/gsea/downloads.jsp
1.1. download zip file 1.2. unzip and move to known location (e.g. in
...
columns column 1 = gene symbols, column 2 = weight or rank metric for
more details, see:
https://software.broadinstitute.org/cancer/software/gsea/wiki/index.php/Data_formats#RNK:\_Ranked_list_file_format\_.28.2A.rnk.29
