...
- image_list:
  ...
  Filepaths to unregistered images

- save_dir:

  (Optional) If given, save registered images to this directory
...
- spatloc_reg_name:
  ...
  name for registered spatial locations to. Defaults to replacement of
  spat_unreg (optional)
