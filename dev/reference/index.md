...
- [`showGiottoInstructions()`](https://giotto-suite.github.io/GiottoClass/reference/showGiottoInstructions.html)
  : Show giotto instructions (from GiottoClass)
...
- [`normParam()`](https://giottosuite.com/dev/reference/process_param.md)
  ...
  [`filterParam()`](https://giottosuite.com/dev/reference/process_param.md)
  [`pcaParam()`](https://giottosuite.com/dev/reference/process_param.md)
...
- [`markersParam()`](https://giottosuite.com/dev/reference/analyze_param.md)
  [`analyzeParam()`](https://giottosuite.com/dev/reference/analyze_param.md)
...
- [`analyzeData(`*`<ANY>`*`,`*`<giniMarkersParam>`*`)`](https://giottosuite.com/dev/reference/markers_gini.md)
