...
- image_reg_name:
  ...
  arbitrary name for registered images to occupy. Defaults to
  replacement of "image" (optional)

- image_replace_name:

  arbitrary name for any images replaced due to image_reg_name argument
  (optional)
...
- spatloc_reg_name:
  ...
  name for registered spatial locations. Defaults to replacement of
  "raw" (optional)

- spatloc_replace_name:

  arbitrary name for any spatial locations replaced due to
  spatloc_reg_name argument (optional)

- xml_files:

  atomic vector of filepaths to xml outputs from FIJI
