...
- \* 1. average gene expression for cells within a grid, see
  createSpatialGrid \* 2. perform PCA on the average grid expression
  profiles \* 3. convert variance of principal components (PCs) to
  z-scores and select PCs based on a z-score threshold
